...
// Day 5
router.get('/todayRegistered', User.todayRegistered)
router.get('/todayActive', User.todayActive)
router.get('/weekActive', User.weekActive)
router.get('/monthActive', User.monthActive)
